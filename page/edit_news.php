		...
		<div class = "row">
			<div class="col-md-12">	
				<form action="" method="post">
					<fieldset>
						<legend style="color: green">Редактирование новости</legend>
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
								<label>Заголовок новости</label>
									<input class = "form-control"  type="text" name="title" value="<?php echo htmlspecialchars($row['title']); ?>">
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									<button type="submit" name="edit" class="btn btn-success">Отредактировать новость</button>
