...
$file_out = file("news.txt"); // Считываем весь файл в массив
 
//записываем нужную строку в файл
file_put_contents("old_news.txt", $file_out[$row_number], FILE_APPEND);
...
file_put_contents("news.txt", implode("", $file_out));
